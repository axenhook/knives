 ...
 */
#define	AVL_NODE2DATA(n, o)	((void *)((avl_index_t)(n) - (o)))
#define	AVL_DATA2NODE(d, o)	((struct avl_node *)((avl_index_t)(d) + (o)))
 ...
 */
void *
avl_find(avl_tree_t *tree, int (*compare) (const void*, void *), const void *value, avl_index_t *where)
{
	avl_node_t *node;
	avl_node_t *prev = NULL;
	int child = 0;
	...
	for (node = tree->avl_root; node != NULL;
        ...
        {
		    diff = compare(value, AVL_NODE2DATA(node, off));
        }
...
avl_insert(avl_tree_t *tree, void *new_data, avl_index_t where)
{
	...
	ASSERT(tree);
#ifdef _LP64
	ASSERT(((avl_index_t)new_data & 0x7) == 0);
#endif
...
avl_add(avl_tree_t *tree, void *new_node)
{
	 ...
	 */
	if (avl_find(tree, NULL, new_node, &where) != NULL)
#ifdef _KERNEL
...
avl_destroy_nodes(avl_tree_t *tree, void **cookie)
{
	 ...
	 */
	parent = (avl_node_t *)((avl_index_t)(*cookie) & ~CHILDBIT);
	if (parent == NULL) {
	 ...
	 */
	child = (avl_index_t)(*cookie) & CHILDBIT;
...
check_right_side:
	...
	if (parent == NULL) {
		...
		*cookie = (void *)((avl_index_t)parent | AVL_XCHILD(node));
	}
